...
// If the chest is not yet opened when we click it...
// Open it by setting the variable and changing the frame.
if (!opened) {
	opened = true;
	image_index = 1;
	audio_play_sound(snd_open_chest, 0, false);
	
	// If the next stage is a different scene, then create the key item.
